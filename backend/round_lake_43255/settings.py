"""
Django settings for round_lake_43255 project.
...
ROOT_URLCONF = 'round_lake_43255.urls'
...
WSGI_APPLICATION = 'round_lake_43255.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_lake_43255 API",
    "DESCRIPTION": "API documentation for round_lake_43255 App",
    "VERSION": "v1",
}
